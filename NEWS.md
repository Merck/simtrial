...
- `wlr()` is now a S3 class method for both `tte_data` class and `counting_process` class 
(@276, #280, @281, thanks to @jdblischak)
- The randomization ratio is output as attributes of `sim_pw_surv()` 
(#279, #311 thanks to @LittleBeannie and @jdblischak).
