...
Application of the above is demonstrated using higher-level routines `simPWSurv()` and `sim_fixed_n()` to generate simulations and weighted logrank analysis for a stratified design.
